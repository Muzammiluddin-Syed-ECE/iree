...
// Test that size-1 outer dimensions on scales broadcast against larger
// iteration bounds (multi_pack with scale packing).
#contraction_accesses = [
 affine_map<(i, j, k, b) -> (i, k, b)>,
 affine_map<(i, j, k, b) -> (k, b, j)>,
 affine_map<(i, j, k, b) -> (i, k)>,
...
func.func @vector_scaled_multi_mma_broadcast(
...
// CHECK-LABEL: func @vector_scaled_multi_mma_broadcast
//       CHECK:   iree_codegen.inner_tiled ins(%arg0, %arg1, %arg2, %arg3) outs(%arg4)
//  CHECK-SAME:     kind = #iree_gpu.scaled_mma_layout<intrinsic = MFMA_SCALE_F32_16x16x128_B32, lhs_elem_type = f4E2M1FN, rhs_elem_type = f8E4M3FN, acc_elem_type = f32, multi_pack = [1, 1, 4, 4, 1]>
//  CHECK-SAME:     : vector<1x4x1x32xf4E2M1FN>, vector<4x1x1x32xf8E4M3FN>, vector<1x1x4xf8E8M0FNU>, vector<1x1x4xf8E8M0FNU> into vector<1x1x4xf32>
