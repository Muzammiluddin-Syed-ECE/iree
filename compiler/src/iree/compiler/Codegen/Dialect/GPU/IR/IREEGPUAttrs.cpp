...
LogicalResult ScaledMMAAttr::buildUnderlyingOperations(
  ...
  // Shape_cast all operands from flat 1D to multi-dim.
...
void ScaledMMAAttr::getInnerIteratorTypes(
  ...
  result.assign({utils::IteratorType::parallel,   // M
                 utils::IteratorType::parallel,   // N
                 utils::IteratorType::reduction,  // K
                 utils::IteratorType::reduction}); // KB
}
