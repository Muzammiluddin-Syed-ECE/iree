...
// RUN: iree-opt --pass-pipeline="builtin.module(func.func(iree-codegen-materialize-device-encoding{test-gpu-encoding-resolver=gpu_data_tiling}))" \
// RUN:   --iree-gpu-test-target=gfx950 --iree-gpu-partial-dt-scaled-mma \
// RUN:   --split-input-file %s | FileCheck %s --check-prefix=PDT
...
// PDT-LABEL:   func.func @set_encoding_LHS_unroll8x8x2_MFMA_I32_16x16x64_I8
...
// PDT-LABEL:   func.func @set_encoding_RHS_unroll8x8x2_MFMA_I32_16x16x64_I8
...
// PDT-LABEL:   func.func @set_encoding_ACC_unroll8x8x2_MFMA_I32_16x16x64_I8
...
// PDT-LABEL:   func.func @unset_encoding_ACC_unroll8x8x2_MFMA_I32_16x16x64_I8
...
// PDT-LABEL: func.func @matmul_lowering_MFMA_I32_16x16x64_I8
...
// PDT-LABEL: func.func @batch_matmul_lowering_MFMA_F32_16x16x128_F8E4M3FN
...
// PDT-LABEL: func.func @batch_matmul_lowering_MFMA_F32_16x16x32_BF16
// CHECK-DAG: #[[MAP0:.+]] = affine_map<(d0, d1, d2, d3) -> (d0, d1, d3)>
// CHECK-DAG: #[[MAP1:.+]] = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>
// CHECK-DAG: #[[MAP2:.+]] = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>
...
// CHECK:         return %[[TRANSPOSE]]
//
// PDT-LABEL: func.func @set_encoding_LHS_scaled_matmul_f4_f4_f8_f8_f32(
...
// CHECK:         return %[[TRANSPOSE]]
//
// PDT-LABEL: func.func @set_encoding_RHS_scaled_matmul_f4_f4_f8_f8_f32(
// PDT:         %[[PACK:.*]] = linalg.pack %{{.+}} padding_value(%{{.+}} : f4E2M1FN)
// PDT-SAME:      outer_dims_perm = [0, 1, 2]
// PDT-SAME:      inner_dims_pos = [0, 1, 2]
// PDT-SAME:      inner_tiles = [16, 8, 32]
...
// CHECK:         return %[[TRANSPOSE]]
//
// PDT-LABEL: func.func @set_encoding_LHS_SCALES_scaled_matmul_f4_f4_f8_f8_f32(
...
// CHECK:         return %[[TRANSPOSE]]
//
// PDT-LABEL: func.func @set_encoding_RHS_SCALES_scaled_matmul_f4_f4_f8_f8_f32(
// PDT:         %[[PACK:.*]] = linalg.pack %{{.+}} padding_value(%{{.+}} : f8E8M0FNU)
// PDT-SAME:      outer_dims_perm = [0, 1]
// PDT-SAME:      inner_dims_pos = [0, 1]
// PDT-SAME:      inner_tiles = [16, 8]
...
// PDT-LABEL:   func.func @set_encoding_ACC_scaled_matmul_f4_f4_f8_f8_f32(
...
//
// PDT-DAG: #[[MAP0:.+]] = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>
// PDT-DAG: #[[MAP1:.+]] = affine_map<(d0, d1, d2, d3) -> (d1, d2, d3)>
// PDT-DAG: #[[MAP2:.+]] = affine_map<(d0, d1, d2, d3) -> (d0, d2)>
// PDT-DAG: #[[MAP3:.+]] = affine_map<(d0, d1, d2, d3) -> (d1, d2)>
// PDT-DAG: #[[MAP4:.+]] = affine_map<(d0, d1, d2, d3) -> (d0, d1)>
// PDT:     func.func @scaled_matmul_lowering_large_f4_f4_f8_f8_f32(
...
//
// PDT:     func.func @scaled_matmul_lowering_f4_f4_f8_f8_f32(
...
//
// PDT:     func.func @scaled_matmul_lowering_f8_f8_f8_f8_f32(
...
//
// PDT:     func.func @scaled_matmul_lowering_f4_f4_f8_f8_f32_MFMA_SCALE_F32_32x32x64_B32(
...
// PDT-LABEL: func.func @matvec_lowering_f16f16f32
...
// PDT-LABEL: func.func @vecmat_lowering_f32f32f32
...
// The output tensor is packed as tensor<8x29x4x16x4xf32> with swizzle permutation.
// Original dim 0 (M) maps to: d0 * 16 + (d4 + d2 * 4)
