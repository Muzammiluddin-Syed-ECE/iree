...
// Tests for DataTiledScaledMMAAttr with unshuffled_operands materialization:
...
//   - Scaled matmul lowers to inner_tiled with data_tiled_scaled_mma_layout kind
...
//-----------------------------------------------------------------------------
// Scaled matmul inner_tiled formation with DataTiledScaledMMAAttr (unshuffled) kind
//-----------------------------------------------------------------------------
...
// CHECK-SAME:    kind = #iree_gpu.data_tiled_scaled_mma_layout<
